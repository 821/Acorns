...
漢語大詞典本身有很多奇怪的地方，比如把「示」的新舊字形當作截然不同的字做獨立解釋。而「示」的舊字形沒有獨立的編碼，所以本文件將二者合倂。
表中數百字使用頁碼或獨立號碼表示，現在全部改正。對於 Unicode 沒有的字，則使用拆字法。
表中有些怪錯，比如「矇瞍」出現兩次，查原書，發現後一個應該是「矇𥈟」，「轗𨎺」和「轗𨎹」、「蹴踏」和「蹴蹹」、「霶𩃰」和「霶𩃱」、「韭菹」和「韭葅」、「𪒱𪑠」和「𪒱𪒡」也誤作同一個。更神奇的還有「蟑螂」的「螂」都打錯。均改正。
