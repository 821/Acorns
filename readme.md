...
據原書修補了呂、宮、吳、嘯、㘊、嚘、壚、姸、媼、嶪、憂、𢥘、坺、摲、𢶡、掔、攕、𢹲、攮、攣、哂、昴、晝、杠、㭒、搥、譥、絣、竇、逬、⿰足幷、餠、餘、膞、䕓、𥹤、玂、禪、麈、哆、禠、譶、樁、庛、剌、蠯、鵃、䚢、𧕰、皃、𦢌、鴂、縳、罼、獆、麡、啑、胄、𧏚、鳴、嘗、疁、畼、晝、獎、娜、䣛、嬴、㝔、寠、歭、㢮、彄、惲、𢝰、昡、眘、晙、皙、㬉、䁔、曈、禊、櫺、櫱、櫾、櫜、櫎、瀹、溈、滋、⿰氵茲、灈、𤄶、灟、為等字（多數是搞錯偏旁部首，用形近字，錄入者可能是用了非常不淸晰的掃描版來對照，也可能是在 OCR 的基礎上粗校而成）和部分排序，刪去多餘的字。
